  ...
  const buildCommandManualPages = ({ section = "todos", detailed = false } = {}) => {
    ...
    const sections = {
      ...
      economia: [
        ...
        { cmd: `${prefix}coinsranking`, usage: `${prefix}coinsranking [global|local]`, effect: "ranking de moedas (local/grupo ou global)", badges: ["GRUPO"] },
        { cmd: `${prefix}xpranking`, usage: `${prefix}xpranking [global|local]`, effect: "ranking de XP (local/grupo ou global)", badges: ["GRUPO"] },
