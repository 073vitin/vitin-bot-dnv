  ...
  const buildCommandManualPages = ({ section = "todos", detailed = false } = {}) => {
    ...
    const sections = {
      ...
      partidas: [
        ...
        { cmd: `${prefix}criar memoria`, aliases: [], usage: `${prefix}criar memoria`, effect: "inicia memoria", badges: ["GRUPO"] },
        { cmd: `${prefix}criar reacao`, aliases: [], usage: `${prefix}criar reacao`, effect: "inicia reacao", badges: ["GRUPO"] },
        { cmd: `${prefix}criar comando`, aliases: [], usage: `${prefix}criar comando`, effect: "inicia comando", badges: ["GRUPO"] },
      ],
      economia: [
