...
const gatilhos = [
  ...
  [["kk","kkkk","haha","rs"], ["Você ri... mas eu consigo ver através disso, essa tentativa fraca de macron o vazio que existe aí dentro.","Risos registrados... normalmente usados como defesa emocional quando você não sabe como reagir de verdade.","Engraçado... você ri, mas não há nada realmente engraçado acontecendo, apenas você tentando escapar da própria realidade."]],
...
const historias = [
  ...
  ["Você tem amigos?","Pessoas que realmente te conhecem?","Ou apenas pessoas que conhecem a versão de você que você permite que vejam?","Porque há uma diferença.","Uma diferença abissal.","E você sabe disso.","Mais continua fingindo que não."],
  ...
  ["Você já pensou se está vivendo a vida errada?","Que em algum lugar, em alguma realidade, você fez escolhas diferentes?","E nessa outra vida, você é feliz?","Mas aqui, nesta realidade, você está preso.","Com as escolhas que fez.","E não há volta.","Apenas aceitação."]
]
...
const comparacoes = {
  ...
  cruel: [
    ...
    "@{alvo1} é lost. @{alvo2} é encontrado.",
